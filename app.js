new Vue({
    ...
    methods: {
        ...
        async fetchLessons() {
            try {
                const response = await fetch('https://express-js-gbxb.onrender.com/lessons');
        ...
        async fetchOrders() {
            const response = await fetch('https://express-js-gbxb.onrender.com/order_placed');
        ...
        async placeOrder() {
            ...
            if (response.ok) {
                ...
                await fetch('https://express-js-gbxb.onrender.com/lessons/updateSpaces', {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
